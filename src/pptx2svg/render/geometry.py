...
SPEC_PRESETS: dict[str, "_Spec"] = {
    ...
    # --- Banners and scrolls -------------------------------------------------------------
    # Scrolls and ribbons draw their own shading: the curled-under part of a scroll and
    # the folded-back tails of a ribbon are separate paths with `darkenLess`, which is
    # what gives them their depth.
    "verticalScroll": _Spec(
        adjustments=(("adj", 12500),),
        guides=(
            ("a", "pin 0 adj 25000"),
            ("ch", "*/ ss a 100000"),
            ("ch2", "*/ ch 1 2"),
        ...
        paths=(
            _P(
                ("M", "ch2", "b"),
                ("A", "ch2", "ch2", "cd4", "-5400000"),
                ("L", "ch2", "y4"),
                ("A", "ch4", "ch4", "cd4", "-10800000"),
                ("L", "ch", "y3"),
                ("L", "ch", "ch2"),
                ("A", "ch2", "ch2", "cd2", "cd4"),
                ("L", "x7", "t"),
    ...
    "horizontalScroll": _Spec(
        ...
        paths=(
            _P(
                ...
                ("L", "x3", "ch"),
                ("L", "ch2", "ch"),
                ("A", "ch2", "ch2", "3cd4", "-5400000"),
                ("L", "l", "y7"),
                ("A", "ch2", "ch2", "cd2", "-10800000"),
                ("L", "ch", "y6"),
                ("L", "x4", "y6"),
                ("A", "ch2", "ch2", "cd4", "-5400000"),
                ("Z",),
    ...
    "ellipseRibbon": _Spec(
        adjustments=(("adj1", 25000), ("adj2", 50000), ("adj3", 12500),),
        guides=(
            ("a1", "pin 0 adj1 100000"),
    ...
    "leftRightRibbon": _Spec(
        adjustments=(("adj1", 50000), ("adj2", 50000), ("adj3", 16667),),
        guides=(
            ("a3", "pin 0 adj3 33333"),
            ("maxAdj1", "+- 100000 0 a3"),
            ("a1", "pin 0 adj1 maxAdj1"),
    ...
    "gear6": _Spec(
        adjustments=(("adj1", 15000), ("adj2", 3526),),
        guides=(
            ("a1", "pin 0 adj1 20000"),
            ("a2", "pin 0 adj2 5358"),
            ("th", "*/ ss a1 100000"),
    ...
    "gear9": _Spec(
        adjustments=(("adj1", 10000), ("adj2", 1763),),
        guides=(
            ("a1", "pin 0 adj1 20000"),
            ("a2", "pin 0 adj2 2679"),
            ("th", "*/ ss a1 100000"),
    ...
    "funnel": _Spec(
        ...
        paths=(
            _P(
                ("M", "x1", "y1"),
                ("A", "wd2", "hd4", "stAng1", "swAng1"),
                ("L", "x3", "y2"),
                ("A", "rw3", "rh3", "da", "swAng3"),
                ("Z",),
                ("M", "x2", "hd4"),
                ("A", "rw2", "rh2", "cd2", "-21600000"),
                ("Z",),
            ),
        ),
    ),
    ...
    "nonIsoscelesTrapezoid": _Spec(
        adjustments=(("adj1", 25000), ("adj2", 25000),),
        guides=(
            ("maxAdj", "*/ 50000 w ss"),
...
PRESET_GEOMETRIES: dict[str, Generator] = {
    ...
    # Banners and scrolls
    "verticalScroll": _spec_generator("verticalScroll"),
    "horizontalScroll": _spec_generator("horizontalScroll"),
    "ellipseRibbon": _spec_generator("ellipseRibbon"),
    "ellipseRibbon2": _spec_generator("ellipseRibbon2"),
    "leftRightRibbon": _spec_generator("leftRightRibbon"),
    # Gears, tabs and miscellaneous
    "gear6": _spec_generator("gear6"),
    "gear9": _spec_generator("gear9"),
    "funnel": _spec_generator("funnel"),
    "pieWedge": _spec_generator("pieWedge"),
    "cornerTabs": _spec_generator("cornerTabs"),
    "squareTabs": _spec_generator("squareTabs"),
    "plaqueTabs": _spec_generator("plaqueTabs"),
    "nonIsoscelesTrapezoid": _spec_generator("nonIsoscelesTrapezoid"),
    "chartPlus": _spec_generator("chartPlus"),
    "chartStar": _spec_generator("chartStar"),
    "chartX": _spec_generator("chartX"),
    "flowChartOfflineStorage": _spec_generator("flowChartOfflineStorage"),
}
